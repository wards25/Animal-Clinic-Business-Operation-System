            ...
            <div class="app-content-area">
                ...
                <div class="container-fluid mt-n22 ">
                    ...
                    <div class="card">
                        ...
                        $sqls = $con->prepare("SELECT * FROM ordertb WHERE status='pending'");
                        $sqls->execute();
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="transactionForm" method="post">
                            <label for="orderInput" class="form-label">Order No.</label>
                            <input type="text" class="form-control" id="orderNoInput" name="orderNo">
                            <div class="mb-3">
                                <label for="amountInput" class="form-label">Amount</label>
                                <input type="text" class="form-control" id="amountInput" name="amount">
                            </div>
                            <div class="mb-3">
                                <label for="referenceNoInput" class="form-label">Reference No</label>
                                <input type="text" class="form-control" id="referenceNoInput" name="referenceNo">
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.transac-btn').click(function() {
            ...
            modal.find('#orderNoInput').val(orderNo);
            modal.modal('show');
            // Enable/disable referenceNoInput based on payment type
            if (paymentType === 'cash') {
                modal.find('#referenceNoInput').prop('disabled', true);
            } else if (paymentType === 'gcash') {
                modal.find('#referenceNoInput').prop('disabled', false);
            }
        });
        ...
        $('#transactionForm').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = "transac.php";
                },
