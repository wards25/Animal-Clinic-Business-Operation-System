            ...
            <div class="app-content-area">
                ...
                <div class="container-fluid mt-n22 ">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="mb-2 mb-lg-0">
                                    <h3 class="mb-0  text-white">Scheduled Appointments</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        $sqls = $con->prepare("SELECT * FROM appointmenttb WHERE status ='confirmed' ORDER BY created_at ASC LIMIT 10");
                        $sqls->execute();
                                            ...
                                            while ($row = $results->fetch_assoc()) {
                                                ...
                                                echo '
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <a href="updatedTreatedStatus.php?appointmentNo=' . $appoinmentNo . '&status=fulfilled"><button type="submit" class="btn btn-success approv-btn" name="confirmed"><i class="fa-regular fa-thumbs-up"></i> Treated</button>
