    ...
    <div class="container">
        <div class="wrapper">
            ...
            <div class="chat-container">
                <div id="chat-box"></div>
                <input type="hidden" value="13" id="receiver_id">
                <div class="input-group mb-3">
                    <input class="form-control" type="text" id="message" placeholder="Type your message" style="margin-top: 10px;">
                    <span class="input-group-text" id="basic-addon1" style="margin-top: 10px;"><button class="btn btn-primary" onclick="sendMessage()">Send</button></span>
                </div>
            </div>
        </div>
    </div>
...
<script>
    // JavaScript for sending and fetching messages
    ...
    function sendMessage() {
        ...
        $.ajax({
            type: "POST",
            url: "sendMessageUser.php",
            data: {
                message: message,
                receiver_id: receiver_id
            },
            success: function(response) {
                // Handle successful sending of message
