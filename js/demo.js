    ...
    (()=>{
            ...
            handleInvalidInsertion(e, t, n) {
                if (this.allowReslicing && e.touchingEntry) {
                    const r = Object.assign(Object.assign({}, t), {
                        span: eo(t.span, e.touchingEntry.span)
                    });
                    n.push(r),
        ...
        class ua extends xi {
            constructor(e, t={}) {
                ...
                ,
                function(e) {
                    e.isConnected && e.getRootNode && Me(e.getRootNode())
                }(e),
                this.el = e,
        ...
        class Ac {
            ...
            joinProps(e, t) {
                ...
                for (let t of d) {
                    ...
                    r.push(t ? d.businessHourSegs : Tc),
                    i.push(t ? d.fgEventSegs : Tc),
        ...
        function _c(e, t) {
            return Mc(e, [], t, !1, {}, !0).map((e=>e.resource))
        }
        function Mc(e, t, n, r, i, o) {
            let s = function(e, t, n, r) {
                ...
                for (let e in i) {
                    let s = i[e];
                    s.resource.parentId || Hc(s, o, n, 0, t, r)
                }
                return o
            }(e, r ? -1 : 1, t, n)
              , a = [];
            return Ic(s, a, r, [], 0, i, o),
            a
        }
            ...
            for (let a = 0; a < e.length; a += 1) {
                ...
                if (d)
                    if (n) {
                        let e = t.length
                          , a = r.length;
                        if (Ic(l.children, t, n, r.concat(0), i, o, s),
                        e < t.length) {
                            let n = t[e];
        ...
        function Hc(e, t, n, r, i, o) {
            if (n.length && (-1 === i || r <= i)) {
                ...
                Hc(e, s.children, n.slice(1), r + 1, i, o)
            } else
                Oc(e, t, o)
        }
        function Oc(e, t, n) {
        ...
        var Jc = bs({
            ...
            isPropsValid: function(e, t) {
                let n = (new pc).splitProps(Object.assign(Object.assign({}, e), {
        ...
        function Ru(e, t, n, r, i) {
            let o = bl(e, t);
            return r ? new Rc(o,n,i) : new Cc(o,n,i)
        }
        var Tu = bs({
        ...
        window.isCalendarThemeRender ? window.renderCalendarTheme = function(e, t, n) {
            !function(e) {
                let t = e.callback || function() {}
                  ...
                  , i = (o = e.themeSystemName,
                s = e.themeName,
                "bootstrap5" === o ? s ? "https://bootswatch.com/5/" + s + "/bootstrap.min.css" : "https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" : "bootstrap" === o ? s ? "https://bootswatch.com/4/" + s + "/bootstrap.min.css" : "https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css" : void 0);
                var o, s;
                i && r.push(i),
                n(!0),
                function(e, t) {
