var defaultEvents = []
  , viewEventModal = new bootstrap.Modal(document.getElementById("view-event-modal"),{
    keyboard: !1
})
  , addEditEventModal = new bootstrap.Modal(document.getElementById("add-edit-event-modal"),{
    keyboard: !1
})
...
const getInitialView = ()=>768 <= window.innerWidth && window.innerWidth < 1200 ? "timeGridWeek" : window.innerWidth <= 768 ? "listMonth" : "dayGridMonth"
  , getDateValue = (document.addEventListener("DOMContentLoaded", function() {
    ...
    document.body.contains(t) && t.addEventListener("click", function(e) {
        ...
        confirm("Are you sure want to delete this event ?") && (r.getEventById(t).remove(),
        viewEventModal.hide())
    }),
