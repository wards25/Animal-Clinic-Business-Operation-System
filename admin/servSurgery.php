        ...
        <div id="app-content">
            ...
            <div class="app-content-area">
                ...
                <div class="container-fluid mt-n22 ">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="mb-2 mb-lg-0">
                                    <h3 class="mb-0  text-white">Surgery queuing</h3><br>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <?php
                        $sqls = $con->prepare("SELECT * FROM appointmenttb WHERE status ='confirmed' AND service LIKE '%surgery%' ORDER BY created_at DESC LIMIT 10");
                        $sqls->execute();
