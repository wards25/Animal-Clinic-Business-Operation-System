        ...
        <div id="app-content">
            ...
            <div class="app-content-area">
                ...
                <div class="container-fluid mt-n22 ">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="mb-2 mb-lg-0">
                                    <h3 class="mb-0  text-white">Vaccine queuing</h3><br>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <?php
                        $sqls = $con->prepare("SELECT * FROM appointmenttb WHERE status ='vax' AND service LIKE '%vaccine%' ORDER BY created_at LIMIT 10");
                        $sqls->execute();
                            ...
                            <div class="table-responsive table-card">
                                <div id="liveSearchResults">
                                        ...
                                        <table class="table text-nowrap mb-0 table-centered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = $results->fetch_assoc()) {
                                                    ...
                                                    $services = explode("grooming, consultation, ", $row['service']); // Split services by comma
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="updatedTreatedStatus.php?appointmentNo=' . $appointmentNo . '&status=processed" class="btn btn-success approv-btn">Completed</a>
