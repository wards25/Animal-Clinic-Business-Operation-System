            ...
            <div class="app-content-area">
                ...
                <div class="container-fluid mt-n22 ">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="mb-2 mb-lg-0">
                                    <h3 class="mb-0  text-white">Appointment List</h3><br>
                    ...
                    <div class="card">
                        ...
                        $sqls = $con->prepare("SELECT * FROM appointmenttb WHERE status ='processed' ORDER BY created_at");
                        $sqls->execute();
                                            ...
                                            while ($row = $results->fetch_assoc()) {
                                                ...
                                                echo '
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <button type="button" class="btn btn-primary btn-prescription" data-bs-toggle="modal" data-bs-target="#exampleModal" data-appointment-no=' . $appointmentNo . '>+ Prescription</button>
                                                        <button type="button" class="btn btn-success transac-btn" data-bs-toggle="modal" data-bs-target="#static" data-appointment-no=' . $appointmentNo . ' data-service=' . $service . '><i class="fa-regular fa-thumbs-up"></i> Fulfilled</button>
                                                        </td>
                                                    </tr>';
                                            }
                                        } else {
        ...
        <div class="modal fade" id="medicalHistoryModal" tabindex="-1" aria-labelledby="medicalHistoryModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="medicalHistoryBody">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered  modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <button class="btn btn-primary" id="medicalHistoryBtn">Medical History</button>
                        <form method="post">
...
<script>
    ...
    // Add an event listener to the medical history button
    document.getElementById('medicalHistoryBtn').addEventListener('click', function() {
        // Hide the prescription modal
        var prescriptionModal = document.getElementById('exampleModal');
        prescriptionModal.classList.remove('show');
        prescriptionModal.style.display = 'none';
    });

    // Add an event listener to the medical history modal's close button
    document.getElementById('medicalHistoryModal').addEventListener('hidden.bs.modal', function () {
        // Show the prescription modal again
        var prescriptionModal = document.getElementById('exampleModal');
...
<script>
    $(document).ready(function() {
        $("#medicalHistoryBtn").click(function() {
            var petname = $("#petName").val(); // Assuming petname is already populated in the input field
            $.ajax({
                ...
                success: function(response) {
                    // Display the medical history in the modal
                    $("#medicalHistoryBody").html(response);
