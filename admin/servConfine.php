                                            ...
                                            <li class="nav-item">
                                                ...
                                                <div id="navinvoice" class="collapse " data-bs-parent="#sideNavbar">
                                                    ...
                                                    <li class="nav-item">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link has-arrow " href="serv.php">
                                                                Confinement
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
        ...
        <div id="app-content">
            ...
            <div class="app-content-area">
                ...
                <div class="container-fluid mt-n22 ">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-5">
                                <div class="mb-2 mb-lg-0">
                                    <h3 class="mb-0  text-white">Confinement queuing</h3><br>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <?php
                        $sqls = $con->prepare("SELECT * FROM appointmenttb WHERE status ='confirmed' AND service LIKE '%confinement%' ORDER BY created_at DESC LIMIT 10");
                        $sqls->execute();
                            ...
                            <div class="table-responsive table-card">
                                <div id="liveSearchResults">
                                        ...
                                        <table class="table text-nowrap mb-0 table-centered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = $results->fetch_assoc()) {
                                                    ...
                                                    $services = explode(", ", $row['service']); // Split services by comma
                                                    ...
                                                    // Find the index of 'grooming' in the services array
                                                    $groomingIndex = array_search('grooming', $services);
                                                    if ($groomingIndex !== false && isset($services[$groomingIndex + 1]) && $services[$groomingIndex + 1] == 'consultation') {
                                                        $nextServicePage = 'servConsult.php'; // Redirect to consultation page
                                                    } else {
                                                        // Handle case when 'grooming' is not found, or next service is not 'consultation'
                                                        $nextServicePage = 'defaultpage.php'; // Redirect to a default page
                                                    }
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="updatedTreatedStatus.php?appointmentNo=' . $appointmentNo . '&status=consult" class="btn btn-success approv-btn">Completed</a>
